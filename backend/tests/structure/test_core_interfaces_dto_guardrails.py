...
def test_interfaces_does_not_define_dataclass_dtos():
    ...
    for protocol_file in ["case_protocols.py", "contract_protocols.py", "document_protocols.py", 
                          "automation_protocols.py", "organization_protocols.py", "service_locator.py"]:
