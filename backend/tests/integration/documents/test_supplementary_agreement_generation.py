...
from apps.contracts.models import (
    Contract, SupplementaryAgreement, SupplementaryAgreementParty, 
    ContractParty, PartyRole
)
from apps.documents.models import DocumentTemplateType, DocumentContractSubType
...
class TestSupplementaryAgreementGenerationIntegration:
    ...
    def setup_method(self):
        ...
        self.contract = ContractFactory(
            ...
            specified_date=timezone.localdate()
        )
    ...
    def test_generate_supplementary_agreement_success(self):
        ...
        try:
            ...
            # 调用生成服务
            content, filename, error = self.service.generate_supplementary_agreement(
                self.contract.id, agreement.id
            )
    ...
    def test_context_building(self):
        ...
        agreement = self._create_supplementary_agreement(
            name="测试补充协议",
            principals=[self.client1, self.client2],
            opposing=[self.client3]
        )
