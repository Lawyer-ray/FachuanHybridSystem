...
from apps.automation.models import ScraperTask, CourtDocument, DocumentDownloadStatus
...
class TestCourtDocumentIntegration:
    ...
    def test_api_intercept_to_download_to_db_success(
        self,
        mock_download,
        mock_intercept
    ):
    ...
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._intercept_api_response')
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._download_document_directly')
    def test_api_intercept_to_download_partial_failure(
        self,
        mock_download,
        mock_intercept
    ):
...
class TestCourtDocumentFallbackMechanism:
    ...
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._download_via_api_intercept_with_navigation')
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._download_via_fallback')
    def test_fallback_triggered_on_api_timeout(
        self,
        mock_fallback,
        mock_api_intercept
    ):
    ...
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._download_via_api_intercept_with_navigation')
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._download_via_fallback')
    def test_fallback_triggered_on_api_error(
        self,
        mock_fallback,
        mock_api_intercept
    ):
    ...
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._download_via_api_intercept_with_navigation')
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._download_via_fallback')
    def test_both_methods_fail_raises_exception(
        self,
        mock_fallback,
        mock_api_intercept
    ):
...
class TestCourtDocumentConcurrentDownload:
    ...
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._download_document_directly')
    @patch('time.sleep')
    def test_concurrent_download_with_delay(
        self,
        mock_sleep,
        mock_download,
        mock_intercept
...
class TestCourtDocumentPerformanceOptimization:
    ...
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._intercept_api_response')
    @patch('apps.automation.services.scraper.scrapers.court_document.CourtDocumentScraper._download_document_directly')
    def test_batch_save_performance(
        self,
        mock_download,
        mock_intercept
    ):
    ...
    def test_database_query_optimization(
        ...
        with CaptureQueriesContext(connection) as context:
            documents = CourtDocument.objects.filter(
                scraper_task=self.scraper_task
