...
class TestSMSParserJysdLink:
    ...
    def test_extract_jysd_link_from_sms(self):
        test_sms = (
            ...
            "为保障您的合法权益，请点击 `https://jysd.10102368.com/sd?key=pKbAL9Jgv3UtIcSk-6275369f_01`  查看并下载文书。"  # noqa: E501
        )
    ...
    def test_extract_multiple_jysd_links(self):
        test_sms = "链接1: https://jysd.10102368.com/sd?key=abc123_01 链接2: https://jysd.10102368.com/sd?key=xyz789_02"
