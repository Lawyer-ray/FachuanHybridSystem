...
class TestDocumentClassifier:
    ...
    @patch(
        "apps.automation.services.court_document_recognition.document_classifier.chat"
    )
    def test_classify_summons(self, mock_chat):
        """测试识别传票"""
        mock_chat.return_value = {
            "message": {
                "content": '{"type": "summons", "confidence": 0.95, "reason": "包含开庭时间"}'
            }
        }
    ...
    def test_classify_execution_ruling(self, mock_chat):
        ...
        mock_chat.return_value = {
            "message": {
                "content": '{"type": "execution", "confidence": 0.88, "reason": "包含财产保全"}'
            }
        }
    ...
    def test_classify_other(self, mock_chat):
        ...
        mock_chat.return_value = {
            "message": {
                "content": '{"type": "other", "confidence": 0.6, "reason": "无法确定类型"}'
            }
        }
    ...
    def test_classify_confidence_clamping(self, mock_chat):
        ...
        mock_chat.return_value = {
            "message": {
                "content": '{"type": "summons", "confidence": -0.5}'
            }
        }
    ...
    def test_classify_long_text_truncation(self, mock_chat):
        ...
        mock_chat.return_value = {
            "message": {
                "content": '{"type": "summons", "confidence": 0.9}'
            }
        }
