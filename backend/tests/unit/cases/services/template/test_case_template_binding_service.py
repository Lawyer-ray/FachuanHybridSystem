...
class TestCaseTemplateBindingService:
    ...
    def service(self, mock_document_service, mock_repo):
        return CaseTemplateBindingService(document_service=mock_document_service, repo=mock_repo)
    ...
    def test_bind_template_success(self, service, mock_repo, mock_document_service):
        ...
        mock_repo.create_binding.assert_called_with(
            case_id=case_id, template_id=template_id, source=BindingSource.MANUAL_BOUND
        )
