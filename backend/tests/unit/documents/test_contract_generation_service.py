...
from apps.contracts.models import Contract, ContractParty, ContractAssignment, PartyRole
...
def mock_contract(db):
    ...
    contract = Contract.objects.create(
        name="测试合同",
        case_type="civil",
        representation_stages=["first_trial", "appeal"]
    )
...
class TestContractGenerationService:
    ...
    def test_generate_contract_document_template_not_found(
        self, contract_generation_service, mock_contract
    ):
        """测试模板不存在的情况"""
