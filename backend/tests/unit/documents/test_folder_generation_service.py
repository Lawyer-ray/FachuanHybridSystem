...
class TestFolderGenerationService:
    ...
    def test_generate_folder_structure(self):
        ...
        # Mock 模板
        mock_template = Mock()
        mock_template.structure = {"name": "template_root", "children": [{"name": "folder1"}, {"name": "folder2"}]}
    ...
    def test_create_zip_package(self):
        """测试创建ZIP包"""
        folder_structure = {"name": "test_folder", "children": [{"name": "subfolder1"}, {"name": "subfolder2"}]}

        documents = [("", b"content1", "file1.txt"), ("subfolder1", b"content2", "file2.txt")]
