...
def test_import_pattern_matching():
    ...
    test_cases = [
        # (输入行, 预期是否匹配, 预期新行)
        ("from apps.tests.factories import CaseFactory", True, "from tests.factories import CaseFactory"),
        (
            "from apps.tests.factories.case_factories import CaseFactory",
            True,
            "from tests.factories.case_factories import CaseFactory",
        ),
        ("import apps.tests.factories", True, "import tests.factories"),
        ("from apps.cases.tests import TestCase", True, "from tests.unit.cases import TestCase"),
        ("from apps.tests.mocks import MockService", True, "from tests.mocks import MockService"),
