...
from apps.client.services.identity_extraction.data_classes import (
    ExtractionResult, OCRExtractionError, OllamaExtractionError
)
from apps.client.models import ClientIdentityDoc
from apps.core.exceptions import ValidationException, ServiceUnavailableError
...
class TestIdentityExtractionService:
    ...
    def test_extract_success(self):
        ...
        with patch('apps.client.services.identity_extraction.extraction_service.ollama_chat', return_value=ollama_response):
    ...
    def test_ollama_extraction_error(self):
        ...
        # Mock Ollama 返回错误
        with patch('apps.client.services.identity_extraction.extraction_service.ollama_chat', side_effect=Exception("Ollama failed")):
    ...
    def test_ollama_connection_error(self):
        ...
        # Mock Ollama 连接错误
        with patch('apps.client.services.identity_extraction.extraction_service.ollama_chat', side_effect=ConnectionError("Connection failed")):
