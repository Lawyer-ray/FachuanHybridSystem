...
from apps.core.exceptions import NotFoundError, BusinessError
...
class TestAPIExceptionConversion:
    ...
    def test_validation_exception_converts_to_http_response(
        self,
        error_message,
        error_code
    ):
        ...
        with patch('apps.automation.api.preservation_quote_api.PreservationQuoteService') as MockService:
            ...
            mock_service.create_quote.side_effect = ValidationError(
    ...
    def test_not_found_exception_converts_to_http_response(
        self,
        error_message
    ):
        """
        ...
        with patch('apps.automation.api.preservation_quote_api.PreservationQuoteService') as MockService:
            mock_service = MockService.return_value
            mock_service.get_quote.side_effect = NotFoundError(
                message=error_message,
                code="NOT_FOUND"
            )
    ...
    def test_service_validation_error_has_structured_errors(
        self,
        page
    ):
        """
