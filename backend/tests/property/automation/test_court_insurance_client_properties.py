...
class TestExceptionHandlingProperties:
    ...
    async def test_property_network_errors_raise_network_error(self, bearer_token: str, c_pid: str, fy_id: str):
        """
    ...
    @settings(max_examples=100, deadline=None)
    async def test_property_connect_errors_raise_network_error(self, bearer_token: str, c_pid: str, fy_id: str):
        """
        **Feature: backend-architecture-refactoring, Property 2: 业务错误抛出自定义异常**
        **Validates: Requirements 5.1**
    ...
    async def test_property_exception_structure_consistency(self, bearer_token: str, c_pid: str, fy_id: str):
        """
        **Feature: backend-architecture-refactoring, Property 2: 业务错误抛出自定义异常**
