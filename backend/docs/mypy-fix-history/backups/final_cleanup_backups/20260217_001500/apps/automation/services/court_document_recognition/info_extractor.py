...
"""
    ...
    def _parse_summons_response(self, response: Dict[str, Any]) -> dict[str, Any][str, Any]:
        """
        解析传票信息提取响应
    ...
    def _parse_execution_response(self, response: Dict[str, Any]) -> dict[str, Any][str, Any]:
        """
        解析执行裁定书信息提取响应
