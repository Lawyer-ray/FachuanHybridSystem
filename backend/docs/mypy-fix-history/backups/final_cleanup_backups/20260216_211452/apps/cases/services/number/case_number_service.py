...
class CaseNumberService(DjangoPermsMixin):
    ...
    def create_number(
        ...
        # 规范化案号
        normalized_number = self.normalize_case_number(number)  # type: ignore[call-arg]
        ...
        logger.info(
            ...
            extra={
                "action": "create_number",
                "number_id": case_cast(int, number.id),
                "case_id": case_id,
    ...
    def update_number(
        ...
        if number is not None:
            ...
            data["number"] = self.normalize_case_number(number)  # type: ignore[call-arg]
