...
class YamlProvider(ConfigProvider):
    ...
    def load(self) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ConfigFileError(str(self.config_path), line=line_no, message=f"YAML 格式错误: {e}")
    ...
    def save_config(self, config: Dict[str, Any]) -> None:
        ...
        try:
            ...
            with open(self.config_path, "w", encoding="utf-8") as f:
                yaml.dump(nested_config, f, default_flow_style=False, allow_unicode=True, indent=2, sort_keys=True)
            ...
            raise ConfigFileError(str(self.config_path), message=f"保存配置文件失败: {e}")
    ...
    def generate_template(self, config_schema: Dict[str, Any]) -> str:
        ...
        # 转换为 YAML 字符串
        return yaml.dump(template_config, default_flow_style=False, allow_unicode=True, indent=2, sort_keys=True)
