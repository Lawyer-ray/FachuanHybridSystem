...
class FolderTemplateStructureIdRepairService:
    ...
    def detect_cross_template_duplicates(self, *, templates: list[FolderTemplate]) -> set[Any][str]:
    ...
    def repair_structure_ids_global(self, *, structure: dict[str, Any], global_used_ids: set[str]) -> tuple[dict, int]:
