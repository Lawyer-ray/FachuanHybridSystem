...
class PowerOfAttorneyPlaceholderService(BasePlaceholderService):
    ...
    placeholder_keys: ClassVar = ['授权委托书_委托人信息', '授权委托书_受托人信息', '授权委托书_代理事项', '授权委托书_委托人签名盖章信息']
    placeholder_metadata: ClassVar = {'授权委托书_委托人信息': {'display_name': '授权委托书_委托人信息', 'description': '按我方当事人生成,区分自然人/法人,多人用空行分隔', 'example_value': '委托人名称:XX公司\n统一社会信用代码:...\n法定代表人:...\n地址:...\n\n委托人姓名:张三\n身份证号码:...\n地址:...'}, '授权委托书_受托人信息': {'display_name': '授权委托书_受托人信息', 'description': '按案件律师生成,主办在前;只有 1 个律师时补一段空白', 'example_value': '受托人姓名:主办律师A\n工作单位:律所名称\n联系电话:...\n联系地址:...\n\n受托人姓名:\n工作单位:\n联系电话:\n联系地址:'}, '授权委托书_代理事项': {'display_name': '授权委托书_代理事项', 'description': '按代理事项规则表匹配生成(无命中则为空,由生成器决定是否允许下载)', 'example_value': '代为提起诉讼、参与庭审、代收法律文书等'}, '授权委托书_委托人签名盖章信息': {'display_name': '授权委托书_委托人签名盖章信息', 'description': '按我方当事人生成签名盖章区块,日期使用指定日期(为空默认今天)', 'example_value': '委托人(盖章):AAA公司\n法定代表人(签名):A小线\n日期:2026年01月22日'}}
    ...
    def generate(self, context_data: dict[str, Any]) -> dict[str, Any]:
        ...
        return {'授权委托书_委托人信息': self._format_principals(selected_clients), '授权委托书_受托人信息': self._format_lawyers(case), '授权委托书_代理事项': self._format_proxy_matters(context_data, case=case, selected_clients=selected_clients), '授权委托书_委托人签名盖章信息': self._format_signatures(selected_clients, specified_date_text=specified_date_text)}
    ...
    def _format_one_lawyer_block(self, lawyer: Any | None) -> str:
        ...
        return '\n'.join([f'受托人姓名:{name}', f'工作单位:{firm_name}', f'联系电话:{phone}', f'联系地址:{firm_address}'])
    ...
    def _pick_best_rule(self, matched: Any) -> None:
        ...
        def mode_rank(mode: str) -> int:
            ...
            if mode == ProxyMatterRule.LegalStatusMatchMode.ALL:
                return 2
            return 1
        matched.sort(key=lambda r: (-int(bool(r.case_type)), -int(bool(r.case_stage)), -int(bool(r.legal_statuses)), -mode_rank(getattr(r, 'legal_status_match_mode', '')), int(getattr(r, 'priority', 100)), int(getattr(r, 'id', 0))))
        return matched[0]

    def _get_party_legal_statuses(self, context_data: dict[str, Any], *, case: Any, selected_clients: list[Any]) -> set[Any][str]:
