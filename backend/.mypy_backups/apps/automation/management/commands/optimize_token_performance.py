            ...
            try:
                ...
                if health_report['alerts']:
                    ...
                    for alert in health_report['alerts']:
                        severity_style = {'high': self.style.ERROR, 'medium': self.style.WARNING, 'low': self.style.NOTICE}.get(alert['severity'], self.style.NOTICE)
                        self.stdout.write(severity_style(f'  [{alert['severity'].upper()}] {alert['message']}'))
                else:
