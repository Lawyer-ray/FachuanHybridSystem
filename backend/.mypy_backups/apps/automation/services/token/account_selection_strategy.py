...
from apps.core.interfaces import AccountCredentialDTO, IAccountSelectionStrategy
...
class AccountSelectionStrategy:
    ...
    async def select_account(
        self, site_name: str, exclude_accounts: Optional[List[str]] = None
    ...
    async def update_account_statistics(self, account: str, site_name: str, success: bool) -> None:
        ...
        try:
            ...
            if success:
                ...
                logger.info(
                    f"账号登录成功统计已更新",
                    extra={"account": account, "site_name": site_name, "success_count": success_count},
                )
            else:
                # 失败后添加到黑名单
                ...
                logger.warning(
                    f"账号登录失败统计已更新",
                    extra={"account": account, "site_name": site_name, "failure_count": failure_count},
                )
