...
class DocumentProcessingServiceAdapter(IDocumentProcessingService):
    ...
    def extract_text_from_pdf(
        self, file_path: str, limit: Optional[int] = None, preview_page: Optional[int] = None
    ) -> Dict[str, Any]:
        """
        从PDF文件提取文本
        ...
        try:
            ...
            raise AutomationExceptions.pdf_processing_failed(str(e))

    def extract_text_from_docx(self, file_path: str, limit: Optional[int] = None) -> str:
        """
        从DOCX文件提取文本
        ...
        try:
            ...
            raise AutomationExceptions.docx_processing_failed(str(e))

    def extract_text_from_image(self, file_path: str, limit: Optional[int] = None) -> str:
        """
        从图片文件提取文本（OCR）
        ...
        try:
            ...
            raise AutomationExceptions.image_ocr_failed(str(e))

    def process_uploaded_document(
        self, uploaded_file: Any, limit: Optional[int] = None, preview_page: Optional[int] = None
    ) -> Dict[str, Any]:
        """
        处理上传的文档
        ...
        try:
            ...
            raise AutomationExceptions.document_content_extraction_failed(str(e))
    ...
    def extract_text_from_docx_internal(self, file_path: str, limit: Optional[int] = None) -> str:
        """从DOCX文件提取文本（内部接口，无权限检查）"""
        return self.extract_text_from_docx(file_path, limit)

    def extract_text_from_image_internal(self, file_path: str, limit: Optional[int] = None) -> str:
