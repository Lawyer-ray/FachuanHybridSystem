...
from ..data_classes import DocumentRecord, DocumentDeliveryRecord, DocumentQueryResult, DocumentProcessResult
...
class DocumentDeliveryApiService:
    ...
    def __init__(self, api_client: Optional[CourtDocumentApiClient]=None, case_matcher: Optional['CaseMatcher']=None, document_renamer: Optional['DocumentRenamer']=None, notification_service: Optional['SMSNotificationService']=None):
        """
        初始化 API 查询服务
        ...
        try:
            ...
            for num in existing_numbers:
                if num.number == case_number:
                    ...
                    return True
            case_number_service.create_number_internal(case_id=case_id, number=case_number, remarks='文书送达自动下载同步')
    ...
    def _record_query_history_in_thread(self, credential_id: int, entry: DocumentDeliveryRecord) -> None:
        ...
        def do_record():  # type: ignore[ServiceLocator]
            try:
