...
class LLMClient:
    ...
    def chat(
        ...
        *,
        ...
        return fallback_policy.execute(operation=operation, backend=backend_name, fallback=fallback)
    ...
    async def achat(
        ...
        *,
        ...
        backend_name = backend or self._default_backend
        return await fallback_policy.execute_async(operation=operation, backend=backend_name, fallback=fallback)
