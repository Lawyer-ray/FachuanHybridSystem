...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options) -> None:
        ...
        if dry_run:
            ...
            return
        service = CaseAssignmentService(case_service=ServiceLocator.get_case_service(), contract_assignment_query_service=ServiceLocator.get_contract_assignment_query_service())
        created_total = 0
        deleted_total = 0
