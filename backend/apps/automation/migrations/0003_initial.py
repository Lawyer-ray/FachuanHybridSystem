...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            name='credential',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_schedules', to='organization.accountcredential', verbose_name='账号凭证'),
        ),
        migrations.AddField(
            model_name='documentqueryhistory',
            name='court_sms',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='query_histories', to='automation.courtsms', verbose_name='关联短信记录'),
        ),
        migrations.AddField(
            model_name='documentqueryhistory',
            name='credential',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='document_query_histories', to='organization.accountcredential', verbose_name='账号凭证'),
        ),
        migrations.AddField(
            model_name='documentrecognitiontask',
            name='case',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='recognition_tasks', to='cases.case', verbose_name='关联案件'),
        ),
        migrations.AddField(
            model_name='documentrecognitiontask',
            name='case_log',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='recognition_tasks', to='cases.caselog', verbose_name='案件日志'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='quotes', to='automation.preservationquote', verbose_name='询价任务'),
        ),
        migrations.AddField(
            model_name='scrapertask',
            name='case',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='scraper_tasks', to='cases.case', verbose_name='关联案件'),
        ),
        migrations.AddField(
            model_name='courtsms',
            name='scraper_task',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='court_sms_records', to='automation.scrapertask', verbose_name='下载任务'),
        ),
        migrations.AddField(
            model_name='courtdocument',
            name='scraper_task',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='automation.scrapertask', verbose_name='爬虫任务'),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            model_name='documentrecognitiontask',
            index=models.Index(fields=['status', '-created_at'], name='automation__status_b57405_idx'),
        ),
        migrations.AddIndex(
            model_name='documentrecognitiontask',
            index=models.Index(fields=['case'], name='automation__case_id_13ae57_idx'),
        ),
        migrations.AddIndex(
            model_name='documentrecognitiontask',
