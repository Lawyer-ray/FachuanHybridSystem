...
if TYPE_CHECKING:
    ...
    class _JysdHost(Protocol):
        ...
        def _jysd_get_iframe(self) -> Any: ...
        def _jysd_click_details_button(self, page_ctx: Any, frame: Any) -> None: ...
        def _jysd_get_table_rows(self, page_ctx: Any, frame: Any) -> Any: ...
        def _jysd_download_all_rows(
            self, rows: Any, row_count: int, download_dir: Any
        ) -> tuple[list[str], list[dict[str, Any]], int, int]: ...
        def _jysd_resolve_frame(self) -> Any: ...
        def _jysd_wait_after_click(self, frame: Any) -> None: ...
        def _jysd_save_iframe_debug(self, frame: Any) -> None: ...
        def _jysd_save_download(
            self, download: Any, doc_name: str, index: int, download_dir: Any
        ) -> Any: ...
