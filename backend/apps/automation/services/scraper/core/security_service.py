...
class SecurityService:
    ...
    @staticmethod
    def mask_sensitive_data(data: dict, keys: list[Any] = None) -> dict[str, Any][str, Any]:
        """
        脱敏敏感数据（用于日志）
    ...
    @staticmethod
    def encrypt_config(config: dict) -> dict[str, Any]:
        """
        加密配置中的敏感字段
    ...
    @staticmethod
    def decrypt_config(config: dict) -> dict[str, Any]:
        """
        解密配置中的敏感字段
...
class SecurityServiceAdapter(ISecurityService):
    ...
    def mask_sensitive_data(self, data: dict, keys: list[Any] = None) -> dict[str, Any][str, Any]:
        """脱敏敏感数据"""
        return self.service.mask_sensitive_data(data, keys)

    def encrypt_config(self, config: dict) -> dict[str, Any]:
        """加密配置中的敏感字段"""
        return self.service.encrypt_config(config)

    def decrypt_config(self, config: dict) -> dict[str, Any]:
        """解密配置中的敏感字段"""
    ...
    def mask_sensitive_data_internal(self, data: dict, keys: list[Any] = None) -> dict[str, Any][str, Any]:
        """脱敏敏感数据（内部接口，无权限检查）"""
        return self.service.mask_sensitive_data(data, keys)

    def encrypt_config_internal(self, config: dict) -> dict[str, Any]:
        """加密配置中的敏感字段（内部接口，无权限检查）"""
        return self.service.encrypt_config(config)

    def decrypt_config_internal(self, config: dict) -> dict[str, Any]:
