...
DEFAULT_PROXY_MATTER_RULES: tuple[ProxyMatterRuleSeed, ...] = (
    ...
    },
    {
        ...
        "legal_statuses": ["applicant"],
        "legal_status_match_mode": "any",
        "items_text": "代为提出、撤回仲裁申请，代为承认、放弃、变更、增加仲裁请求，代为进行庭内或庭外和解，代为参与仲裁庭组织的调解，并代为签署调解协议或调解笔录，代为签收仲裁裁决书、决定书、通知书等全部仲裁文书，代为办理与本案相关的其他必要程序性事务。",
        "priority": 100,
        "is_active": True,
    },
    {
    ...
    },
    {
        ...
        "case_stage": "administrative_review",
        "legal_statuses": ["applicant"],
        "legal_status_match_mode": "any",
        "items_text": "代为针对涉案劳动保障监察行政处罚、行政处理事宜提出陈述、申辩意见；提交、补充、调取本案相关证据材料；接受行政询问、沟通、答复案件相关事宜；代为签收、领取、送达本案全部法律文书及文书回执。",
        "priority": 100,
        "is_active": True,
    },
)
