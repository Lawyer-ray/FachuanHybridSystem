...
async def create_assignment(request: HttpRequest, payload: CaseAssignmentIn) -> Any:  # pragma: no cover
    service = _get_case_assignment_service()
    ctx = extract_request_context(request)
...
async def get_assignment(request: HttpRequest, assignment_id: int) -> Any:  # pragma: no cover
    service = _get_case_assignment_service()
    ctx = extract_request_context(request)
...
async def update_assignment(request: HttpRequest, assignment_id: int, payload: CaseAssignmentUpdate) -> Any:  # pragma: no cover
    service = _get_case_assignment_service()
    ctx = extract_request_context(request)
