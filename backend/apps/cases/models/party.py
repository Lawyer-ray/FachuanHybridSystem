...
class CaseParty(models.Model):
    ...
    case: models.ForeignKey[Any, Any] = models.ForeignKey(
        Case, on_delete=models.CASCADE, related_name="parties", verbose_name=_("案件")
    )
    ...
    legal_status: models.CharField[str | None, str | None] = models.CharField(
    ...
    def __str__(self) -> str:
        return f"{self.case_id}-{self.client_id}-{self.legal_status}"  # type: ignore[attr-defined]


class CaseAssignment(models.Model):
    id: int
    case: models.ForeignKey[Any, Any] = models.ForeignKey(
        Case, on_delete=models.CASCADE, related_name="assignments", verbose_name=_("案件")
    )
    lawyer: models.ForeignKey[Any, Any] = models.ForeignKey(
    ...
    def __str__(self) -> str:
        return f"{self.case_id}-{self.lawyer_id}"  # type: ignore[attr-defined]


class CaseAccessGrant(models.Model):
    id: int
    case: models.ForeignKey[Any, Any] = models.ForeignKey(
        Case, on_delete=models.CASCADE, related_name="access_grants", verbose_name=_("案件")
    )
    grantee: models.ForeignKey[Any, Any] = models.ForeignKey(
    ...
    def __str__(self) -> str:
        return f"{self.case_id}->{self.grantee_id}"  # type: ignore[attr-defined]
