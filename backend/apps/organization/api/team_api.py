...
async def delete_team(request: HttpRequest, team_id: int) -> dict[str, bool]:  # pragma: no cover
    await sync_to_async(_team_service.delete_team)(team_id=team_id, user=get_request_user(request))
    return {"success": True}
