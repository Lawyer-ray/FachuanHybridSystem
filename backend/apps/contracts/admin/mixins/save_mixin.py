...
class ContractSaveMixin:
    ...
    def save_model(self, request: object, obj: object, form: Any, change: bool) -> None:
        """
        保存合同模型,处理建档编号逻辑
    ...
    def save_related(self, request: object, form: Any, formsets: Any, change: bool) -> None:
    ...
    def delete_model(self, request: object, obj: object) -> None:
        super().delete_model(request, obj)

    def delete_queryset(self, request: object, queryset: object) -> None:
