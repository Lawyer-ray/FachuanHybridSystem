...
_FOLDER_KEYWORD_TO_ARCHIVE_CODE: dict[str, dict[str, list[str]]] = {
    ...
    "litigation": {
        ...
        "lt_10": ["调查", "取证", "追加第三人", "网络查控", "催促执行", "中止执行", "申请律师调查令", "调查笔录"],
    },
    # criminal
    "criminal": {
