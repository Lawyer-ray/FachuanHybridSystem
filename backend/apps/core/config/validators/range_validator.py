...
class RangeValidator(ConfigValidator):
    ...
    def can_validate(self, field_def: Any) -> bool:
        """检查是否可以验证指定字段"""
        return (
            (hasattr(field_def, "min_value") and field_def.min_value is not None)
            or (hasattr(field_def, "max_value") and field_def.max_value is not None)
            or (hasattr(field_def, "choices") and field_def.choices is not None)
        )
...
class NumericRangeValidator(ConfigValidator):
    ...
    def can_validate(self, field_def: Any) -> bool:
        """检查是否可以验证指定字段"""
        return (
            hasattr(field_def, "type")
            and field_def.type in (int, float)
            and (
                (hasattr(field_def, "min_value") and field_def.min_value is not None)
                or (hasattr(field_def, "max_value") and field_def.max_value is not None)
                or (hasattr(field_def, "step") and field_def.step is not None)
            )
        )
...
class StringLengthValidator(ConfigValidator):
    ...
    def can_validate(self, field_def: Any) -> bool:
        ...
        return (
            hasattr(field_def, "type")
            and field_def.type is str
            and (
                (hasattr(field_def, "min_length") and field_def.min_length is not None)
                or (hasattr(field_def, "max_length") and field_def.max_length is not None)
            )
        )
