...
class CompatibleSettings:
    ...
    def __setattr__(self, name: str, value: Any) -> None:
        ...
        if name.startswith("_") or name in [
            "_config_manager",
            "_django_to_config_mapping",
            "_config_to_django_mapping",
            "_fallback_to_django",
...
# 全局兼容设置实例（可选）
_global_compatible_settings: CompatibleSettings | None = None
_global_settings_proxy: SettingsProxy | None = None


def get_global_compatible_settings() -> CompatibleSettings | None:
    """
    获取全局兼容设置实例
...
def get_global_settings_proxy() -> SettingsProxy | None:
    """
    获取全局设置代理实例
