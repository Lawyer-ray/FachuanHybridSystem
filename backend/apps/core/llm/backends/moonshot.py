...
class MoonshotBackend(HttpxErrorMixin):
    ...
    def upload_file(self, file_path: str) -> dict[str, Any]:
        return self._files_client.upload_file(file_path)

    async def aupload_file(self, file_path: str) -> dict[str, Any]:
        return await self._files_client.aupload_file(file_path)

    def list_files(self) -> dict[str, Any]:
        return self._files_client.list_files()

    async def alist_files(self) -> dict[str, Any]:
        return await self._files_client.alist_files()

    def retrieve_file(self, file_id: str) -> dict[str, Any]:
        return self._files_client.retrieve_file(file_id)

    async def aretrieve_file(self, file_id: str) -> dict[str, Any]:
        return await self._files_client.aretrieve_file(file_id)

    def extract_result(self, file_id: str) -> dict[str, Any]:
        return self._files_client.extract_result(file_id)

    async def aextract_result(self, file_id: str) -> dict[str, Any]:
        return await self._files_client.aextract_result(file_id)
