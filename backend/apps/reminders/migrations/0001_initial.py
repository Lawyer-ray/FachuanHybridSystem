    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['due_at'], name='reminders_r_due_at_b7eb79_idx'), models.Index(fields=['reminder_type'], name='reminders_r_reminde_c61630_idx'), models.Index(fields=['contract'], name='reminders_r_contrac_f13768_idx'), models.Index(fields=['case_log'], name='reminders_r_case_lo_5b9d79_idx')],
                'constraints': [models.CheckConstraint(condition=models.Q(models.Q(('contract__isnull', False), ('case_log__isnull', True)), models.Q(('contract__isnull', True), ('case_log__isnull', False)), _connector='OR'), name='reminders_reminder_bind_exactly_one')],
            },
        ),
    ]
