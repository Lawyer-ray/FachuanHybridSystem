# Generated by Django 6.0.5 on 2026-05-22 01:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.BooleanField(default=False, help_text='同步到案件重要时间：勾选后会在案件详情的重要时间中展示，不会复制生成新数据。', verbose_name='列入重要时间'),
        ),
        migrations.AddField(
            model_name='reminder',
            name='include_in_important_time',
