...
def demo_batch_fix() -> None:
    ...
    errors_by_file = {
        'apps/cases/services/case_service.py': [
            ErrorRecord(
                'apps/cases/services/case_service.py', 100, 0,
                'no-any-return', 'Returning Any', 'medium', False, None
            ),
            ErrorRecord(
                'apps/cases/services/case_service.py', 150, 0,
                'no-any-return', 'Returning Any', 'medium', False, None
            ),
        ],
        'apps/contracts/services/contract_service.py': [
            ErrorRecord(
                'apps/contracts/services/contract_service.py', 200, 0,
                'no-any-return', 'Returning Any', 'medium', False, None
            ),
        ],
    }
