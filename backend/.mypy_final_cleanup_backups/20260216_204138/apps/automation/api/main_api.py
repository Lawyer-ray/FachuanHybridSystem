...
from ..schemas import OllamaChatIn, OllamaChatOut, MoonshotChatIn, MoonshotChatOut
...
def upload_file(request: Any, file: UploadedFile=File(...), limit: int | None=None, preview_page: int | None=None) -> dict[str, Any]:
    """通用文件上传和预处理API"""
    ...
    return {'success': result.success, 'file_info': result.file_info, 'extraction': result.extraction, 'processing_params': result.processing_params, 'error': result.error}
