...
def read_uploaded_image(image: UploadedFile, *, logger: Any) -> Optional[np.ndarray | None]:
    try:
        image.seek(0)
...
def save_temp_image(image: UploadedFile, *, prefix: str, temp_dir: Path, logger) -> str:
