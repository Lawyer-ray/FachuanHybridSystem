...
def validate_image_size(image: np.ndarray, name: str, *, min_image_size: int) -> Optional[dict[str, Any] | None]:
...
def validate_corners(corners: list[list[int]]) -> Optional[str | None]:
