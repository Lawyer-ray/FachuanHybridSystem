...
class LLMConfig:
    ...
    def _get_django_settings_fallback(cls, key: str, default: str = "") -> str:
        ...
        Returns:
            配置值
        """
        siliconflow_config = cast(dict[str, Any], getattr(settings, "SILICONFLOW", {}) or {})
    ...
    def get_ollama_model(cls) -> str:
        ...
        # Fallback 到 Django settings
        ollama_config = cast(dict[str, Any], getattr(settings, "OLLAMA", {}) or {})
    ...
    def get_moonshot_api_key(cls) -> str:
        ...
        moonshot_config = cast(dict[str, Any], getattr(settings, "MOONSHOT", {}) or {})
    ...
    def get_default_backend(cls) -> str:
        ...
        llm_settings = cast(dict[str, Any], getattr(settings, "LLM", {}) or {})
