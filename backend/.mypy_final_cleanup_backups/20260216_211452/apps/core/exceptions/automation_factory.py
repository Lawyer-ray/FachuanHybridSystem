...
class AutomationExceptions:
    ...
    def captcha_recognition_failed(
        details: Optional[str] = None, processing_time: Optional[float] = None
    ) -> ValidationException:
        """验证码识别失败异常"""
        errors: Dict[str, Any] = {}
        if details:
    ...
    def captcha_recognition_error(
        error_message: str, original_exception: Optional[Exception] = None
    ) -> ValidationException:
        """验证码识别异常"""
    ...
    def token_acquisition_failed(
        reason: str, site_name: Optional[str] = None, account: Optional[str] = None
    ) -> BusinessException:
        """Token获取失败异常"""
    ...
    def login_timeout_error(
        timeout_seconds: int, site_name: Optional[str] = None, account: Optional[str] = None
    ) -> BusinessException:
        """登录超时异常"""
    ...
    @staticmethod
    def create_document_failed(error_message: str, api_data: Optional[Dict[str, Any]] = None) -> BusinessException:
        """创建文档失败异常"""
        errors: Dict[str, Any] = {"error_message": error_message}
        if api_data:
    ...
    @staticmethod
    def unsupported_file_format(file_ext: str, supported_formats: Optional[List[str]] = None) -> ValidationException:
        """不支持的文件格式异常"""
    ...
    @staticmethod
    def text_extraction_failed(error_message: str, file_path: Optional[str] = None) -> ValidationException:
        """文本提取失败异常"""
        errors: Dict[str, Any] = {"error_message": error_message}
        if file_path:
    ...
    def ai_service_unavailable(
        service_name: str = "Ollama", error_message: Optional[str] = None
    ...
    @staticmethod
    def recognition_timeout(timeout_seconds: float, operation: Optional[str] = None) -> "AutomationException":
        """识别超时异常"""
    ...
    @staticmethod
    def info_extraction_failed(error_message: str, document_type: Optional[str] = None) -> BusinessException:
        """信息提取失败异常"""
        errors: Dict[str, Any] = {"error_message": error_message}
        if document_type:
