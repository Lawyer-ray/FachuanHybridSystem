...
后来参加了司法局的比赛，临时 Vibe Coding 了一个作品，评委送进了决赛。决赛要认真准备，于是就有了法穿 AI Copilot——把以前想做的事情，重新做一遍。比赛最后拿了二等奖，金杜也是二等奖。
...
- **作者亲自远程部署**，部署全程附带交流讲解，边部署边答疑，交付即可使用
- **每台机器 500 元**，一次性收费
- 支持 **Windows / Linux / macOS**（**推荐 macOS**，与开发环境一致，体验最佳）

需要部署服务，可通过下方公众号「法穿」联系作者。
